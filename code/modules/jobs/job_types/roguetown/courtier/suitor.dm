/datum/job/roguetown/suitor
	...
	tutorial = "You are a noble from a foreign house who has travelled to Azure Peak in order to win the hand of a court noble and secure a political ally for your house. Competition is fierce, and it seems you're not the only one vying for the courts favor..."
