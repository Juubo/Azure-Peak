/proc/get_spellblade_chant_html(datum/caller, mob/living/carbon/human/H, faction = "conventional", extra_blade_weapon, extra_phalanx_weapon, extra_mace_weapon)
	...
	switch(faction)
		...
		if("zizite")
			blade_weapons = "Kriegmesser / Longsword / Rapier / Sabre / Steel Arming Sword / Steel Greatsword / Steel Dagger & Shield"
		...
		if("noccite")
			blade_weapons = "Longsword / Rapier / Sabre / Steel Arming Sword / Steel Greatsword / Steel Dagger & Shield"
			phalanx_weapons = "Halberd / Bardiche / Boar Spear / Dory & Shield / Naginata"
			mace_weapons = "Steel Mace / Steel Warhammer & Shield / Grand Mace"
		if("undead")
			...
			blade_weapons = "Longsword / Rapier / Sabre / Iron Arming Sword / Shortsword / Hwando / Steel Dagger & Shield"
