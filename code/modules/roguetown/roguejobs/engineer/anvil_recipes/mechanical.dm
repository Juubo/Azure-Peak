...
/datum/anvil_recipe/engineering/mess_kit
	name = "Mess Kit (+2 Tin)" // 3 Iron, cuz you get a pot, a pan and other things for free.
	req_bar = /obj/item/ingot/iron
...
/datum/anvil_recipe/engineering/artificerarmor
	name = "Artificer armor (+2 ancient alloy ingot, +2 cogs)"
...
/datum/anvil_recipe/engineering/volticgauntlet
	name = "Voltic Gauntlet (+1 Tin ingot, +2 cogs, +1 cinnabar ore)"
	req_bar = /obj/item/ingot/bronze
...
/datum/anvil_recipe/engineering/steamshield
	name = "Steam Shield (+1 wood plank, +2 cogs, +2 bronze ingot)"
	req_bar = /obj/item/ingot/iron
