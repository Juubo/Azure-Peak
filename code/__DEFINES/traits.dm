...
// Generic traits, Please see if there is a better category for these below before adding
...
//Antag related traits
#define TRAIT_BANDITCAMP "banditcamp"
#define TRAIT_VAMPMANSION "vampiremansion" //used for vampires
#define TRAIT_VAMP_DREAMS "vamp_dreams" //used for vampires
#define TRAIT_MANIAC_AWOKEN "Awoken"
#define TRAIT_NOSLEEP "Fatal Insomnia" //used for vampires
...
#define TRAIT_VAMPIRE_THRALL "Vampire's Thrall" //adding in if we want vampire's to have thralls
#define TRAIT_VAMPIRISM "Vampirism" //used for bloodsuckers, can be used for vampires
#define TRAIT_VAMP_HEAL_LIMIT "Healing Ability Limit" //used for bloodsuckers
#define TRAIT_VAMP_ANCIENT "Ancient Vampire" //used for bloodsuckers, can be used on vampires
#define TRAIT_WEAK_VEIL "Weak Veil" //used for bloodsuckers

//Arcane related traits
...
//Training traits, something that relates to being trained
#define TRAIT_BADTRAINER "Bad Trainer"
#define TRAIT_GOODTRAINER "Good Trainer"
#define TRAIT_STUDENT		"Student"

//Miracles and gods related
// Ascendant god general traits
