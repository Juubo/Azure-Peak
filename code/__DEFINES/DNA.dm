...
#define MAX_PENIS_SIZE 7
#define DEFAULT_PENIS_SIZE 2

#define PENIS_TYPE_PLAIN 1 //Human
#define PENIS_TYPE_KNOTTED 2
#define PENIS_TYPE_EQUINE 3 //Flared
#define PENIS_TYPE_TAPERED 4
#define PENIS_TYPE_TAPERED_DOUBLE 5 //Hemi
#define PENIS_TYPE_TAPERED_DOUBLE_KNOTTED 6 //Hemiknot
