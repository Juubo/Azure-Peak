...
#define STORYTELLER_FAVOR_LICH (1<<3)
#define STORYTELLER_FAVOR_WEREWOLF (1<<4)
#define STORYTELLER_FAVOR_VAMPIRE_LORD (1<<5)
#define STORYTELLER_FAVOR_DREAMWALKER (1<<6)
#define STORYTELLER_FAVOR_MASQUERADE (1<<7)
#define STORYTELLER_FAVOR_DARK_ITINERANT (1<<8)
#define STORYTELLER_FAVOR_HARD_ANTAGS (STORYTELLER_FAVOR_BANDIT | STORYTELLER_FAVOR_LICH | STORYTELLER_FAVOR_WEREWOLF | STORYTELLER_FAVOR_VAMPIRE_LORD | STORYTELLER_FAVOR_MASQUERADE)
...
#define STORYTELLER_STANDARD_FAVOR_MULTIPLIER 1.5
