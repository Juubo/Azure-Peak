...
/obj/item/reagent_containers/food/snacks/grown/rogue/rosa_petals
	...
	desc = "Crushed rosa petals, yearing to be further dried to draw out its flavor."
...
/obj/item/reagent_containers/food/snacks/grown/rogue/rosa_petals_dried
	...
	desc = "Dried rosa petals, fit for brewing a delicious tea. Combining it with some pumpkin spice should help to elevate its fragrance even more."
	icon = 'modular/Neu_Food/icons/drinks.dmi'
...
/obj/item/reagent_containers/food/snacks/grown/rogue/rosa_petals_spiced
	...
	desc = "A palmful of smells so delightfully rich, destined to be distilled into a damn fine cup of tea."
	icon = 'modular/Neu_Food/icons/drinks.dmi'
