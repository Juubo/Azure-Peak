...
/mob/living/carbon/human/verb/adjust_assets()
	...
	switch(asset_choice)
		if("Belly")
			...
			to_chat(src, span_notice("Attempting to resize your belly..."))
		...
		if("Breasts")
			...
			to_chat(src, span_notice("Attempting to resize your breasts..."))
		...
		if("Penis")
			...
			to_chat(src, span_notice("Attempting to resize your penis..."))
		...
		if("Testicles")
			...
			to_chat(src, span_notice("Attempting to resize your testicles..."))
		...
		if("Butt")
			...
			to_chat(src, span_notice("Attempting to resize your butt..."))
